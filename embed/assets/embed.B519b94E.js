...
`,mb=$`
  ...
  word-wrap: normal;
  max-height: 36px;
`,gb=e=>(()=>{var t=Xr();return U(t,tb),z(t,y(_t,{get href(){return`${mr()}?item=${e.item.id}`},class:rb,get children(){var r=Qw(),n=r.firstChild,a=n.firstChild,i=a.nextSibling,s=i.firstChild,o=s.nextSibling,l=o.nextSibling,u=n.nextSibling;return U(r,nb),U(n,ab),U(a,ib),z(a,y(xn,{get name(){return e.item.name},class:sb,get logo(){return e.item.logo}})),U(i,ob),U(s,lb),z(s,()=>e.item.name),U(o,ub),z(o,y(Q,{get when(){return e.item.organization_name},get children(){return e.item.organization_name}})),U(l,cb),z(l,y(Q,{get when(){return e.item.maturity},get fallback(){return y(Q,{get when(){return e.item.member_subcategory},get children(){var f=eb(),d=f.firstChild;return U(f,`${Jr} ${fb}`),z(f,()=>e.item.member_subcategory,d),ee(()=>fe(f,"title",`${e.item.member_subcategory} member`)),f}})},get children(){return[(()=>{var f=Xr();return U(f,`${Jr} ${hb}`),z(f,()=>e.foundation),ee(()=>fe(f,"title",e.item.maturity)),f})(),(()=>{var f=Xr();return U(f,`${Jr} ${db}`),z(f,()=>e.item.maturity),ee(()=>fe(f,"title",e.item.maturity)),f})()]}}),null),z(l,y(Q,{get when(){return e.item.website},get children(){return y(_t,{title:"Website",class:gi,get href(){return e.item.website},get children(){return y(mi,{get kind(){return Sn.World}})}})}}),null),z(l,y(Q,{get when(){return e.item.primary_repository_url},get children(){return y(_t,{title:"Repository",class:gi,get href(){return e.item.primary_repository_url},get children(){return y(mi,{get kind(){return Sn.GitHubCircle}})}})}}),null),U(u,mb),z(u,()=>e.item.description||"This item does not have a description available yet"),r}})),t})();var yb=se("<button>");const pb={[j.XSmall]:"0.25rem",[j.Small]:"0.35rem",[j.Medium]:"0.5rem",[j.Large]:"0.75rem",[j.XLarge]:"1rem"},_b=we("div")`
...
`,an=we("div")`
  ...
  text-overflow: ellipsis;
  white-space: nowrap;
`,Tb=()=>{const[e,t]=C(""),[r,n]=C(Hw),[a,i]=C(),[s,o]=C(),[l,u]=C(Dw),[f,d]=C(Fw),[m,M]=C(!1),[O,I]=C(Uw),[q,X]=C(jw),[N,K]=C(zw),[G,re]=C(Pw),[Nr,Js]=C(Cw),[Yt,Qs]=C(Yw),[Et,eo]=C(Ew),[to,ro]=C(Iw),[It,no]=C(Nw),[Nt,ao]=C(Lw),[Lt,io]=C(Rw),[Rt,so]=C(Ww),[Re,oo]=C(),[Ft,lo]=C(Gw),[Lr,ht]=C(null),na=()=>`${e()}`,zt=w=>w.sort((H,B)=>H.name.toLowerCase().localeCompare(B.name.toLowerCase()));return go(()=>{const w=new URLSearchParams(window.location.search),H=w.get(Xs),B=w.get(hw),ae=w.get(dw),Wt=w.get(mw),qe=w.get(xw),Rr=w.get(kw),Fr=w.get(Tw),aa=w.get(Ow),ia=w.get(gw),sa=w.get(yw),oa=w.get(_w),la=w.get(ww),ua=w.get(vw),ca=w.get(bw),fa=w.get(Sw),da=w.get(Mw),ha=w.get($w),ma=w.get(pw),ga=w.get(Aw);mo(()=>{if(ae!==null){let ya=!0,pa=!0;if(B!==null&&n(B),u(Wt==="true"),ia!==null&&re(ia==="true"),sa!==null&&Js(sa==="true"),ma!==null&&Qs(ma==="true"),ca!==null&&(ao(ca==="true"),fa!==null)){const ue=parseInt(fa);ue>=10&&ue<=40&&io(ue)}if(qe!==null&&(Object.values(et).includes(qe)?d(qe):pa=!1),Rr!==null&&(Object.values(j).includes(Rr)?K(Rr):ya=!1),Fr!==null&&(I(Fr),M(Fr==="transparent")),aa!==null&&X(aa),la!==null&&ro(la),oa!==null&&eo(oa),ua!==null){const ue=parseInt(ua);ue>=10&&ue<=60&&no(ue)}if(da!==null&&so(da),ha!==null){const ue=parseInt(ha);ue>=0&&oo(ue)}ga!==null&&lo(ga==="true"),ya&&pa?(t(H||""),i(ae)):o(null)}else o(null)})}),sn(_a(a,()=>{async function w(){try{fetch(`${na()}/data/embed_${r()}_${a()}.json`).then(H=>{if(H.ok)return H.json();throw new Error("Something went wrong")}).then(H=>{o(H)}).catch(()=>{o(null)})}catch{o(null)}}typeof a()<"u"&&w()})),sn(_a(Lr,()=>{Lr()!==null&&(window.parent.postMessage({type:"showItemDetails",itemId:Lr(),classifyBy:r(),key:a(),foundation:s().foundation,basePath:na()},"*"),ht(null))})),y(Mb,{get fontFamily(){return to()},get style(){return{all:"initial",isolation:"isolate",overflow:"hidden","--bg-color":O(),"--fg-color":q()}},get children(){return y(Q,{get when(){return s()!==null},get fallback(){return y(fw,{get children(){var w=xb(),H=w.firstChild,B=H.nextSibling;return B.firstChild,z(B,y(_t,{get href(){return`${mr()}/embed-setup`},get children(){return[W(()=>mr()),"/embed-setup"]}}),null),w}})},get children(){return y(Q,{get when(){return typeof s()<"u"},get fallback(){return y(lw,{get bgColor(){return O()}})},get children(){return y(Q,{get when(){return l()},get fallback(){return y(Vt,{get items(){return zt(s().items)},get foundation(){return s().foundation},get style(){return f()},get size(){return N()},get alignment(){return Rt()},get spacing(){return Re()},get displayName(){return Nt()},get itemNameSize(){return Lt()},get displayItemModal(){return Ft()},setActiveItemId:ht})},get children(){return y(Di,{get children(){return[y(Ge,{get when(){return r()===Qt.Category},get children(){return[y(Q,{get when(){return G()},get children(){return y($b,{get isBgTransparent(){return m()},get size(){return It()},get alignment(){return Et()},get uppercase(){return Yt()},get children(){return s().classification.category.name}})}}),y(je,{get each(){return s().classification.category.subcategories},children:(w,H)=>{const B=zt(s().items.filter(ae=>{let Wt=!1;return ae.additional_categories&&(Wt=ae.additional_categories.some(qe=>qe.category===s().classification.category.name&&qe.subcategory===w.name)),ae.category===s().classification.category.name&&ae.subcategory===w.name||Wt}));return[y(an,{get isBgTransparent(){return m()},get size(){return It()},get alignment(){return Et()},get uppercase(){return Yt()},get firstTitle(){return H()===0},get spacing(){return Re()},get children(){return[y(Q,{get when(){return Nr()},get children(){return[W(()=>s().classification.category.name)," -"," "]}}),W(()=>w.name)," (",W(()=>B.length),")"]}}),y(Vt,{items:B,get foundation(){return s().foundation},get style(){return f()},get size(){return N()},get alignment(){return Rt()},get spacing(){return Re()},get displayName(){return Nt()},get itemNameSize(){return Lt()},get displayItemModal(){return Ft()},setActiveItemId:ht})]}})]}}),y(Ge,{get when(){return r()===Qt.Maturity},get children(){return y(je,{get each(){return s().classification.maturity},children:(w,H)=>{const B=zt(s().items.filter(ae=>ae.maturity===w.name));return[y(an,{get isBgTransparent(){return m()},get size(){return It()},get alignment(){return Et()},get uppercase(){return Yt()},get firstTitle(){return H()===0},get spacing(){return Re()},get children(){return[W(()=>Zs(w.name))," (",W(()=>B.length),")"]}}),y(Vt,{items:B,get foundation(){return s().foundation},get style(){return f()},get size(){return N()},get alignment(){return Rt()},get spacing(){return Re()},get displayName(){return Nt()},get itemNameSize(){return Lt()},get displayItemModal(){return Ft()},setActiveItemId:ht})]}})}}),y(Ge,{get when(){return r()===Qt.TAG},get children(){return y(je,{get each(){return s().classification.tag},children:(w,H)=>{const B=zt(s().items.filter(ae=>ae.tag&&ae.tag.includes(w.name)));return[y(an,{get isBgTransparent(){return m()},get size(){return It()},get alignment(){return Et()},get uppercase(){return Yt()},get firstTitle(){return H()===0},get spacing(){return Re()},get children(){return[W(()=>Hv(w.name))," (",W(()=>B.length),")"]}}),y(Vt,{items:B,get foundation(){return s().foundation},get style(){return f()},get size(){return N()},get alignment(){return Rt()},get spacing(){return Re()},get displayName(){return Nt()},get itemNameSize(){return Lt()},get displayItemModal(){return Ft()},setActiveItemId:ht})]}})}})]}})}})}})}})}})},Ob={body:{"overflow-x":"hidden",margin:"0px"}},Ab=tw(Ob),Db=document.getElementById("landscape-embeddable-view");Lo(()=>[y(Ab,{}),y(Tb,{})],Db)});export default Pb();
